...
const EventList = () => {
  ...
  return (
    <>
      <Header />
      <Container className="shadow-sm text-dark mt-5 p-4 rounded">
        <Row className="justify-content-start mt-5">
          <Col md={12} sm={12}>
            <h4 className=" text-primary pb-4">Events</h4>
          </Col>
          {list.map((item, index) => (
            <Col md={6} sm={12} className="shadow-sm text-dark p-4 rounded">
              <h5 className=" text-dark pb-4">{item.title}</h5>
