      ...
      <Container>
        <Row className="justify-content-center">
          <Col
            md={4}
            sm={12}
            className="shadow-sm text-primary mt-5 text-center text-center rounded"
          >
            <img src={logo} alt="eventive logo" />

            <h4 className=" text-primary pb-5 pt-2">Sign Up</h4>
            ...
            <Form className="text-start" onSubmit={handleSubmit}>
              ...
              >
                <Breadcrumb className="mt-4 text-primary" href="/login">
